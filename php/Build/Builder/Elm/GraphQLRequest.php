                    ...
                    Token::array(array_map(function ($query) use ($type, $data, $build) {
                        ...
                        if ($query->isLimitFirst())
                            ...
                            $result []= Token::multi(
                                ...
                                Token::textnlpush(', list  = List.foldr'),
                                Token::textnlpush('(\\item_ list_ ->'),
                                Token::textnl('if List.member item_ list_'),
                                Token::textnl('then list_'),
                                Token::textnlpop('else item_ :: list_'),
                                Token::textnl(')'),
                                Token::textnl('iterator.list'),
                                Token::textnlpop('arg.list'),
